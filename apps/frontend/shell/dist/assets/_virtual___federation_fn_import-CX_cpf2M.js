...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BCcI129A.js', import.meta.url).href),import:true,requiredVersion:'^18.3.1'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BhMZJInU.js', import.meta.url).href),import:true,requiredVersion:'^18.3.1'},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-BS7O1leu.js', import.meta.url).href),import:true,requiredVersion:'^6.26.0'},'zustand':{get:()=>()=>__federation_import(new URL('__federation_shared_zustand-D0V3LbNa.js', import.meta.url).href),import:true},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query-B384mbpg.js', import.meta.url).href),import:true}};
